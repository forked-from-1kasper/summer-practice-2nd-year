...
Множество всех граничных точек называется {\bf границей} и обозначается $\partial A$.
...
\begin{lemma*}
  Множеством предельных точек последовательности $a_i$ является интервал $(x_i, y_i)$.
\end{lemma*}
