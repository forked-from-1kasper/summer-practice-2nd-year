...
\begin{proof}
  ...
  Рассмотрим множество $\Delta = \{ (q, r)\ |\ q \in \Q \land r \in \Q \land B(q, r) \cap A \neq \varnothing \} \subseteq \Q \times \Q$.

  блаблабла
\end{proof}

Каждому $A$ сопоставим некоторое не более чем счётное плотное подмножество и обозначим его $\D(A)$. По его заданию, очевидно, $\overline{\D(A)} = A$.
